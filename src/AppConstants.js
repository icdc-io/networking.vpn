...
export const VPN_CLIENT_CONNECTION_NEXT_IP_FETCH =
	"VPN_CLIENT_CONNECTION_NEXT_IP_FETCH";
export const VPN_CLIENT_CONNECTION_DEVICE_STATS_FETCH =
	"VPN_CLIENT_CONNECTION_DEVICE_STATS_FETCH";
export const VPN_CLIENT_CONNECTION_DEVICES_STATUS_CLEAN =
	"VPN_CLIENT_CONNECTION_DEVICES_STATUS_CLEAN";
export const VPN_CLIENT_CONNECTION_DEVICES_FETCH =
	"VPN_CLIENT_CONNECTION_DEVICES_FETCH";
export const VPN_CLIENT_CONNECTION_DEVICE_CREATE =
	"VPN_CLIENT_CONNECTION_DEVICE_CREATE";
export const VPN_CLIENT_CONNECTION_DEVICE_UPDATE =
	"VPN_CLIENT_CONNECTION_DEVICE_UPDATE";
export const VPN_CLIENT_CONNECTION_DEVICE_DELETE =
	"VPN_CLIENT_CONNECTION_DEVICE_DELETE";
export const VPN_CLIENT_CONNECTION_DEVICE_QR_CODE_URL =
	"VPN_CLIENT_CONNECTION_DEVICE_QR_CODE_URL";
export const VPN_CLIENT_CONNECTION_DEVICE_CONFIGURATION =
	"VPN_CLIENT_CONNECTION_DEVICE_CONFIGURATION";
